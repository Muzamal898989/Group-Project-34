...
<head>
    ...
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&icon_names=person,search,shopping_cart" />
...
<body>
    ...
    <header>
        <div class="header">
            <a href="Home.html"> <img src="images/LogoHeader.jpg" alt="Logo" id="logo-header"> </a>
            <!--Navigates the user to the home page-->
            <form>
                <div class="search"> <!--Users can use this to search the website for meals-->
                    <span class="searchicon material-symbols-outlined">search</span>
                    <input class="searchinput" type="search" placeholder="Find your next craving...">
                </div>
            </form>
            <nav class="header-nav">
                ...
                <a href="About_us.html"> <img src="images/jukeboxicon.png" alt="About" class="jukebox"> </a>
                <!--Navigates the user to the about us page-->
                <a href="login.php" class="signin-header"> Log In </a>
                <!--Placeholder URL and will add functionality to change the button to log out when signed in-->
    ...
    <main>
        ...
        <div class="reviews-section">
            ...
            <p class="reviews"> Jalen Brunson - "Fast, fresh and flawlessly delivered, this service has completely
                transformed the way I order food."</p>
            <p class="reviews"> Cameron Brink - "Every order arrives hot and on time, making this my favourite app for
                meals."</p>
            <p class="reviews"> James Cook - "A seamless experience, offering incredible convenience and consistently
                great meals."</p>
        </div>
    </main>
    ...
    <footer>
        ...
        <div class="footer-nav">
            <a href="About-Us.html" class="footer-link">
                <p>About Us</p>
            </a> <!--Navigates the user to the about us page-->
            <a href="admin_login.php" class="footer-link">
                <p>Staff Login</p>
            </a> <!--Placeholder URL-->
            <a href="menu.php" class="footer-link">
                <p>Our Menu</p>
            </a>
        	<a href="chatbot.html" class="footer-link">
            	<p>Help & Support</p>
        	</a>
        </div>
